      ...
      <div className="rounded-[20px] border border-border-subtle bg-bg-card p-8">
        ...
        <form onSubmit={handleMagicLink} className="mt-8 space-y-3">
          ...
          <input
            ...
            className="w-full rounded-xl border border-border-subtle bg-bg-elevated px-4 py-3 text-sm text-text-primary placeholder:text-text-muted outline-none transition-colors focus:border-accent-green/40 focus:ring-1 focus:ring-accent-green/20"
          />
          <button
            type="submit"
            disabled={loading}
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-border-medium bg-bg-elevated px-4 py-3 text-sm font-medium text-text-primary transition-colors hover:bg-bg-surface"
        >
